...
return (
    ...
    <div className="grid w-[100vw] sm:w-[100%] grid-cols-4 mt-[10vw] grid-rows-2 sm:gap-y-[5.8125rem] gap-x-[12px] sm:mt-0 md:grid-cols-12 md:grid-rows-2 sm:gap-x-[1.5rem]  mx-[1rem] md:mx-[7vw] px-[1rem]">
    ...
    <div className="col-start-3 col-span-2 row-start-2 md:col-start-9 md:col-span-3 flex items-end justify-end mt-0">
        ...
        <div className="text_homeh4 text-[1rem] col-start-1 col-span-4 row-start-3 md:row-start-2 md:col-start-2 md:col-span-5 flex justify-end flex-col md:text-[1.5vw] lg:text-[1.25vw]">
